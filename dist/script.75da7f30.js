...
const SESSION_STORAGE_KEY = "ANIME-SHOW-info";
exports.SESSION_STORAGE_KEY = SESSION_STORAGE_KEY;
const heading = document.querySelector(".h3"); // To round off the rating to only 1 decimal place.
...
}; // Added this so that this wont be called if we jump back to this page because we want to display the info from our search result from info-page.html. So this will only get called when we havent used the search feature on info-page.
