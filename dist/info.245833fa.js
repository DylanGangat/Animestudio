...
const animeId = JSON.parse(sessionStorage.getItem(_grid.SESSION_STORAGE_KEY)); // get the id
...
}; // const getRecommendation = async info => {
//   const animeId = info.mal_id;
...
//     console.log(e);
//   }
//   console.log("hello", animeId);
// };
// getRecommendation(info);
