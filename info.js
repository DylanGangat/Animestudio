...
const animeInfoTemplate = info => {
  ...
  const description = `
    ...
    <div class="image">
      <img src="${image_url}" width="100%" alt="${title} anime image" />
    </div>
  </div>
      `;
  ...
  // Depends on how many genres there are it will populate that amount
  const tags = document.querySelector(".tags");
  genres.forEach(
    genre => (tags.innerHTML += `<a href="#" class="tag">${genre.name}</a>`)
  );
};
  ...
  <div class="anime-card flow-content">
      <div class="image">
          <a href="#">
              ...
              <img class="poster" src="${image_url}" alt="${title} anime image">
          </a>
      </div>
      <div class="info">
          <h3 class="title">
